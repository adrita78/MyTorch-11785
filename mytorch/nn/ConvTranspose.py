...
class ConvTranspose1d():
    def __init__(self, in_channels, out_channels, kernel_size, upsampling_factor,
        ...
        self.conv1d_stride1 = Conv1d_stride1(in_channels, out_channels, kernel_size, weight_init_fn=weight_init_fn, bias_init_fn=bias_init_fn )
...
class ConvTranspose2d():
    def __init__(self, in_channels, out_channels, kernel_size, upsampling_factor,
        ...
        self.conv2d_stride1 = Conv2d(in_channels, out_channels,kernel_size,stride =1,weight_init_fn=weight_init_fn, bias_init_fn=bias_init_fn )
